...
export const FloatingWhatsApp = memo(function FloatingWhatsApp() {
  ...
  const phone = process.env.NEXT_PUBLIC_WHATSAPP_PHONE || '+351912345678';
  const message =
    language === 'pt'
  ...
  return (
    <motion.a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center justify-center w-14 h-14 rounded-full bg-green-500 text-white shadow-2xl hover:bg-green-600 transition-all hover:scale-110 active:scale-95"
